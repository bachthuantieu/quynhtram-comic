  ...
  return (
    <div
      className={classNames(
        "flex items-center border rounded overflow-hidden shadow-input pr-4",
        focus ? "border-gray-600" : "border-gray-400"
      )}
    >
      <input
        id={name}
        ...
        className={classNames("px-4 outline-none h-[44px] flex-1", className)}
